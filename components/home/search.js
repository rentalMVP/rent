const Search = () =>{
    return(
        <section style={{ width:"100%", height:"400px", background:"#161616"}} className="search">
            ...
            <ul className="flex flex-row" style={{width:"fit-content", margin:"auto", marginTop:"10px"}}>
                <li style={{ marginRight:"20px", fontSize:"20px", fontFamily:"Oswald", padding:"5px"}} className="li_text">
                   All
                </li>
                <li style={{ marginRight:"20px", fontSize:"20px", fontFamily:"Oswald", padding:"5px"}} className="li_text">
                   Formal Clothing
                </li>
                <li style={{  fontSize:"20px" , fontFamily:"Oswald", padding:"5px"}} className="li_text">
                    Luxury Car
                </li>
            </ul>
